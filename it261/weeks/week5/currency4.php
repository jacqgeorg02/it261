...
';
if($dollars <= 1000) {
    $embed_code = '<iframe width="560" height="315"  src="https://www.youtube.com/embed/ZTIu4UbkK94?si=vpzj1CCt3T0ApWvc" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';

    echo ' 
    <div class="vid">
    <h2 style="textalign:center">I am NOT happy because</h2>
    <h2 style="textalign:center">I have <b>$'.number_format($dollars, 2).'</b> American dollars!</h2>
    <p>'.$embed_code.'</p>
    </div>';
} else {
    $embed_code = '<iframe width="560" height="315" src="https://www.youtube.com/embed/w9VgxSAIO-I?si=Z0DWSDETfLjbmlal" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>';

    echo ' 
    <div class="vid">
    <h2 style="textalign:center">I am REALLY happy because</h2>
    <h2 style="textalign:center">I have <b>$'.number_format($dollars, 2).'</b> American dollars!</h2>
    <p>'.$embed_code.'</p>
    </div>'; 
}
